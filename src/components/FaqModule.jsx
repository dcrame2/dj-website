...
const data = {
    ...
    questions: [
        ...
        `,
            answer: 'Each businesses goals differ. You must have a conversation with a team member to ensure we align on the scope of your project. We’ve ranged from $1,000 - $20,000.',
        },
        {
            question: 'How long does it take for a website to be built?',
            answer: 'This depends on the scope of your project, we’ve been able to complete websites in 2-3 weeks to 4 months. ',
        },
        {
        ...
        },
        {
            ...
            answer: 'Yes, we handle everything spanning from web design, web development, hosting and content updates.',
        },
        {
            question: 'What does the process of your website include? ',
            answer: 'We follow an Agile approach, we will conduct weekly or bi-weekly status updates throughout the entire project to ensure we are aligned throughout the whole process and meeting your goals.',
        },
        {
            question: 'Do you work with WordPress?',
            answer: 'Yes, we specialize in WordPress with years of experience. We have worked with some of the most complex themes as well as creating custom themes.',
        },
        {
            question: 'Can you make web application or mobile applications?',
            answer: 'Yes, we can create fully custom web applications and mobile applications. These products are a much higher cost to a client due to additional hours commenced.',
        },
    ],
};
